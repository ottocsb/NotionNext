...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hey，我是一个神经病, Hey，我是一个Cryptoer,Hey，我是一个撸狗,非礼勿视',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,个人空间', // 网站关键词 英文逗号隔开
